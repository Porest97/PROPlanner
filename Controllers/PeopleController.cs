...
namespace PROPlanner.Controllers
{
    public class PeopleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,StreetAddress,ZipCode,City,Country,PhoneNumber1,PhoneNumber2,Email,PersonTypeId,CompanyId")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,StreetAddress,ZipCode,City,Country,PhoneNumber1,PhoneNumber2,Email,PersonTypeId,CompanyId")] Person person)
        {
            if (id != person.Id)
            {
                return NotFound();
